...
<style>
    ...
    *[class].blocdbol {display:none !important;}
    .emailButton{
        width: 100% !important;
    }
    .emailButton a {
                        ...
                        <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
                            ...
                            <tr>
                                ...
                                <div class="mktEditable" id="main_text">
                                    ...
                                    We've received a request to reset your password. If you didn't make the request, just ignore this email. Otherwise, you can reset your password using this link.<br><br>
                                </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <div class="mktEditable" id="download_button" style="text-align: center;">
                                    <a target="_blank" style="color:#ffffff; background-color: #ff5802; border: 20px solid #ff5802; border-left: 20px solid #ff5802; border-right: 20px solid #ff5802; border-top: 10px solid #ff5802; border-bottom: 10px solid #ff5802;border-radius: 3px; text-decoration:none;" href="{{$url}}">Click here to reset your password</a><br><br>									
                                </div>
                                </td>
                            </tr>
                                ...
                                <td align="center" valign="middle" class="social" style="border-collapse: collapse;border: 0;margin: 0;padding: 10px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;text-align: center;">
                                    <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
                                        <tr>
                                            ...
                                            {{-- <td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;"><a href="#"><img src="youtube-teal.png"></a></td>
                                            <td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;"><a href="#"><img src="linkedin-teal.png"></a></td>
                                            <td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;"><a href="#"><img src="google-teal.png"></a></td> --}}
