            ...
            <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
                <tr>
                    <td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0; text-align: center; margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #00a5b5">
                        <a href="{{url('/')}}"><img class="logo-image" src="https://dancebuzz-mails.s3-us-west-2.amazonaws.com/dancebuzz/logo.png" style="line-height: 1; width: 200px;" alt=""></a>
                    </td>
                </tr>
                <tr>
                                ...
                                <td class="head-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #333333;font-family: Arial, sans-serif;font-size: 25px;line-height: 34px;font-weight: bold; text-align: center;">
                                    <div class="mktEditable" id="main_title">
                                        @if($vendor->status == \App\Enums\VendorStatus::Active)
                                            Your Registration as our Partner is approved.
                                        @elseif($vendor->status == \App\Enums\VendorStatus::Rejected)
                                            Your Registration with us has been rejected for now. Please try to update valid details or contact us.
                                        @endif
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <table class="content-table" style="padding:0 20px; width:100%; line-height: 28px;">
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Company name:</strong></td>
                                            <td>{{$vendor->name}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Full name:</strong></td>
                                            <td>{{$vendor->contact_first_name}} {{$vendor->contact_last_name}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Contact number:</strong></td>
                                            <td>{{$vendor->contact_phone1}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Email address:</strong></td>
                                            <td>{{$vendor->contact_email}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Registered address:</strong></td>
                                            <td>{{$vendor->address}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">City:</strong></td>
                                            <td>{{$vendor->city}}</td>
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">State:</strong></td>
                                            @if($vendor->state)
                                                <td>{{$vendor->state->name}}</td>
                                            @endif    
                                        </tr>
                                        <tr>
                                            <td><strong style="float:left; width:180px;">Current Status:</strong></td>
                                            <td>{{\App\Enums\VendorStatus::getKey($vendor->status)}}</td>
                                        </tr>

                                        @if($vendor->status == \App\Enums\VendorStatus::Rejected)
                                            <tr>
                                                <td><strong style="float:left; width:180px;">Rejection Reason:</strong></td>
                                                <td>{{$vendor->rejection_reason}}</td>
                                            </tr>
                                        @endif
                                    </table>
                                </td>
