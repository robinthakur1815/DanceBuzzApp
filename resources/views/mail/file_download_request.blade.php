										...
										<table class="content-table" align="center" style="padding:0 20px; width:100%; line-height: 28px;">
											<tr>
												<td style="vertical-align: top !important;">
													...
													Creativity takes courage and we love all your creative, fun-filled ideas and are sure they not only help you innovate but are a means of self-expression and personal growth too!
													<br/>
													<br/>
												</td>
											</tr>
									...
									<td>
										<table class="content-table" style="padding:0 20px; width:100%; line-height: 28px;">
											<tr>
												...
												<td>@if($student_name){{$student_name}} @else NA @endif</td>
											</tr>
											...
											<tr>
												<td style="vertical-align: top !important;"><strong style="float:left; width:180px;">Comment:</strong></td>
												<td>
													@if($story['comment']) {{$story['comment']}} 
													@else Not entered by user
													@endif
												</td>
											</tr>
											...
											<tr>
												<td style="vertical-align: top !important;"><strong style="float:left; width:180px;">Download Url</strong></td>
												<td>
													<a href="{{$url}}" target="_blank">Click here to download file</a>
												</td>
											</tr>
										...
										<table  class="content-table" align="center" style="padding:0 20px; width:100%; line-height: 28px;">
											<tr>
												<td style="width: 580px;">
													<br>
													<br>
														<span style="font-size:12px">Please note: The download URL is temporary and is valid for 2 days ONLY.</span>
													<br/>
													<br/>
