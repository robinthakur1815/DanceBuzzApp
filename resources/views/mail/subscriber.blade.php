					...
					<tr>
						<td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 5px 0 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								<tr>
									<td class="head-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #333333;font-family: Arial, sans-serif;font-size: 25px;line-height: 34px;font-weight: bold; text-align: center;">
										<div class="mktEditable" id="main_title">
											Welcome to Dancebuzz
										</div>
									</td>
								</tr>
								<tr>
									<td class="sub-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;padding-top:5px;-webkit-text-size-adjust: none;color: #ff5802;font-family: Arial, sans-serif;font-size: 18px;line-height: 29px;font-weight: bold;text-align: center;">
									<div class="mktEditable" id="intro_title">
										You are about to start your journey of fun-filled learning and laughter!!!
									</div></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="text" style="border-collapse: collapse;border: 0; margin: 0;padding: 0 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
									<div class="mktEditable" id="main_text">
										{{-- <strong style="color: #333333; font-size: 18px;">Start Exploring</strong><br> --}}
										You have successfully on-boarded your journey of skillful learning and lifelong achievements. Now stay updated on latest classdecks, classes, workshops, events and campaigns near you, informative blogs, and updated stories of our super-achievers to stay motivated and inspired!
									</div>
									</td>
								</tr>
								<tr>
									<td class="text" style="border-collapse: collapse;border: 0; margin: 0;padding: 0 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
									{{-- <div class="mktEditable" id="main_text">
										<strong style="color: #333333; font-size: 18px;">Get Promoted</strong><br>
                                        More info on how many mails/newsletters will be sent weekly can be added</div>
									</td> --}}
								</tr>
								<tr>
									<td class="text" style="border-collapse: collapse;border: 0; margin: 0;padding: 0 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
									{{-- <div class="mktEditable" id="main_text">
										<strong style="color: #333333; font-size: 18px;">Super-Achievers</strong><br>
										Know more about our inspiring champions and how their story is helping millions of other young children to root for their dreams.<br><br>
									</div> --}}
									</td>
								</tr>
										...
										<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
											<tr>
												<td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
													<a href="https://www.facebook.com/dancebuzz/" target="blank">
														<img width="25" src="https://dbemails.s3.ap-south-1.amazonaws.com/facebook.png">
													</a>
												</td>
												<td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
													<a href="https://twitter.com/dancebuzz" target="blank">
														<img width="25" src="https://dbemails.s3.ap-south-1.amazonaws.com/twitter.png">
													</a>
												</td>
												<td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;">
													<a href="https://www.instagram.com/dancebuzz/" target="blank">
														<img width="25" src="https://dbemails.s3.ap-south-1.amazonaws.com/instagram.png">
													</a>
												</td>
											</tr>
										</table>
								...
								<tr>
									<td class="inside-footer" align="center" valign="middle" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 12px;line-height: 16px;vertical-align: middle;text-align: center;width: 580px;">
										<div id="address" class="mktEditable">
											...
											<a style="color: #00a5b5;" href="https://www.dancebuzz.com/contact-us">Contact Us</a>
										</div>
										<a style="color: #00a5b5;" href="https://www.dancebuzz.com/login">Sign In</a>				
									</td>
								</tr>
							</table>
						</td>
