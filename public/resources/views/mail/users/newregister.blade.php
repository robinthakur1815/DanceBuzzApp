                        ...
                        <tr>
                           <td align="left" valign="top">
                              ...
                              <font face="'Source Sans Pro', sans-serif" color="#585858"
                                 ...
                                 <span
                                    style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">You
                                    are registered on DanceBuzz CMS Portal as an
                                    <b>{{\App\Enums\UserRole::getKey($user->role_id)}}</b>. Your username is
                                    <b>{{$user->email}}</b> and password is <b>{{$password}}</b>.</span>
                              </font>
                              <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    ...
                                    <td align="center" valign="top">
                                       <a href="{{$url}}" target="_blank"
                                          ...
                                          <font face="'Source Sans Pro', sans-serif" color="#ffffff"
                                             ...
                                             <span
                                                style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Go
                                                to portal</span>
                                          </font>
                                       </a>
                                    </td>
