                    ...
                    <tr>
                        <td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 5px 0 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
                            <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0; width:100%; padding: 0;font-family: Arial, sans-serif;">
                                ...
                                <tr>
                                    <td>
                                        <table class="content-table" style="padding:0 20px; width:76%; line-height: 28px;">
                                ...
                                $classEndDate =  $class->end_date ? $class->end_date->format('M d, Y') : '';
                                $endTime = $classEndDate ? $classEndDate ." at ". $class->end_time->format('h:i A') : '';
                                ...
                                <tr>
                                    <td>
                                        <table class="content-table" style="padding:0 20px; width:100%; line-height: 28px;">
                                            ...
                                            <tr>
                                                <td style="vertical-align: top !important;">
                                                    <strong style="float:left; width:180px;">
                                                        {{$data['collectionTitle']}} Name:
                                                    </strong>
                                                </td>
                                                <td>{{Str::title($class->name)}}</td>
                                            </tr>
                                            @endif
                                            ...
                                            <tr>
                                                <td style="vertical-align: top !important;">
                                                    <strong style="float:left; width:180px;">Start at:</strong>
                                                </td>
                                                <td>{{$startTime}}</td>
                                            </tr>
                                            @endif
                                            ...
                                            <tr>
                                                <td style="vertical-align: top !important;">
                                                    <strong style="float:left; width:180px;">End at:</strong>
                                                </td>
                                                <td>{{$endTime}}</td>
                                            </tr>
                                            @endif
                                ...
                                @if($collection)
                                    ...
                                    @php
                                        $classDate = $collection->start_date;
                                        $classEndDate = $collection->end_date;
                                        $endTime = $classEndDate ." at ". $end_time;
                                    @endphp
                                        ...
                                        <td>
                                            <table class="content-table" style="padding:0 20px; width:100%; line-height: 28px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{Str::title($collection->title)}}</td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td style="vertical-align: top !important;">
                                                        <strong style="float:left; width:180px;">{{$data['collectionTitle']}} Date Time:</strong>
                                                    </td>
                                                    <td>{{$classDate}}</td>
                                                </tr>
                                                @endif
                                    ...
                                    <td>
                                        <table class="content-table" style="padding:0 20px; width:100%; line-height: 28px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{config('client.currency')}} {{$payment->amount}}</td>
                                            </tr>


                                            @if($created_at)
                                            <tr>
                                                <td style="vertical-align: top !important;"><strong style="float:left; width:180px;">Transaction At:</strong></td>
                                                <td>{{$created_at}}</td>
                                            </tr>
                                            @endif
                                            ...
                                            @if($payment->code)
                                            <tr>
                                                <td style="vertical-align: top !important;"><strong style="float:left; width:180px;">Transaction Id:</strong></td>
                                                <td>{{$payment->code}}</td>
                                            </tr>
                                            @endif
