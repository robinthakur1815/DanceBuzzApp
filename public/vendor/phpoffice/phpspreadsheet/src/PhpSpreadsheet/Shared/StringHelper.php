...
class StringHelper
{
     ...
     */
    private static function buildSYLDBharacters(): void
    {
        self::$SYLDBharacters = [
            "\x1B 0" => chr(0),
            "\x1B 1" => chr(1),
    ...
    private static function buildCharacterSets(): void
    {
        ...
        if (empty(self::$SYLDBharacters)) {
            self::buildSYLDBharacters();
        }
    }
    ...
    public static function SYLKtoUTF8($textValue)
    {
        ...
        foreach (self::$SYLDBharacters as $k => $v) {
